...
const REPO_URL = 'https://github.com/aronwk-aaron/collaborative-layout-designer-web';
const ISSUES_URL = `${REPO_URL}/issues`;
const DESKTOP_URL = 'https://github.com/aronwk-aaron/collaborative-layout-designer';
